    ...
    private static void SeedData(AuctionDbContext context)
    {
        ...
        var auctions = new List<Auction>()
        {
            ...
            new Auction
            {
                ...
                MyProperty = Status.Live,
                ReservePrice = 20000,
                Seller = "bob",
                AuctionDate = DateTime.UtcNow.AddDays(10),
                Item = new Item
                {
                    Make = "Ford",
                    Model = "GT",
            ...
            new Auction
            {
                ...
                ReservePrice = 90000,
                Seller = "alice",
                AuctionDate = DateTime.UtcNow.AddDays(60),
                Item = new Item
                {
                    Make = "Bugatti",
                    Model = "Veyron",
            ...
            new Auction
            {
                ...
                MyProperty = Status.Live,
                Seller = "bob",
                AuctionDate = DateTime.UtcNow.AddDays(4),
                Item = new Item
                {
                    Make = "Ford",
                    Model = "Mustang",
            ...
            new Auction
            {
                ...
                MyProperty = Status.ReserveNotMet,
                ReservePrice = 50000,
                Seller = "tom",
                AuctionDate = DateTime.UtcNow.AddDays(-10),
                Item = new Item
            ...
            new Auction
            {
                ...
                ReservePrice = 20000,
                Seller = "alice",
                AuctionDate = DateTime.UtcNow.AddDays(30),
                Item = new Item
                {
                    Make = "BMW",
                    Model = "X1",
            ...
            new Auction
            {
                ...
                ReservePrice = 20000,
                Seller = "bob",
                AuctionDate = DateTime.UtcNow.AddDays(45),
                Item = new Item
                {
                    Make = "Ferrari",
                    Model = "Spider",
            ...
            new Auction
            {
                ...
                ReservePrice = 150000,
                Seller = "alice",
                AuctionDate = DateTime.UtcNow.AddDays(13),
                Item = new Item
                {
                    Make = "Ferrari",
                    Model = "F-430",
            ...
            new Auction
            {
                ...
                MyProperty = Status.Live,
                Seller = "bob",
                AuctionDate = DateTime.UtcNow.AddDays(19),
                Item = new Item
                {
                    Make = "Audi",
                    Model = "R8",
            ...
            new Auction
            {
                ...
                ReservePrice = 20000,
                Seller = "tom",
                AuctionDate = DateTime.UtcNow.AddDays(20),
                Item = new Item
                {
                    Make = "Audi",
                    Model = "TT",
            ...
            new Auction
            {
                ...
                ReservePrice = 20000,
                Seller = "bob",
                AuctionDate = DateTime.UtcNow.AddDays(48),
                Item = new Item
                {
                    Make = "Ford",
                    Model = "Model T",
